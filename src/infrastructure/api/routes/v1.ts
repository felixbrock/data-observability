...
import qualitativeTestSuiteRoutes from './test-suite-qualitative-routes';
import testSuiteRoutes from './test-suite-routes';
import qualitativeTestSuitesRoutes from './test-suites-qualitative-routes';
...
v1Router.use(`/${appConfig.express.apiRoot}/${version}/qualitative-test-suite`, qualitativeTestSuiteRoutes);
...
v1Router.use(`/${appConfig.express.apiRoot}/${version}/qualitative-test-suites`, qualitativeTestSuitesRoutes);
