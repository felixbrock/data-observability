...
import qualTestSuiteRoutes from './test-suite-qualitative-routes';
import testSuiteRoutes from './test-suite-routes';
import qualTestSuitesRoutes from './test-suites-qualitative-routes';
...
v1Router.use(`/${appConfig.express.apiRoot}/${version}/qualitative-test-suite`, qualTestSuiteRoutes);
...
v1Router.use(`/${appConfig.express.apiRoot}/${version}/qualitative-test-suites`, qualTestSuitesRoutes);
